...
public class Less_25_HW_3_Step3 {
    public static void main(String[] args) {
        ...
        Наши статические методы класса ArraysFindMax, возвращают
        именно то, что нам нужно int. Логика работы каждого из
        методов подобна той, что применялась в предыдущих трех
