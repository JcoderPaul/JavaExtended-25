...
*********************************************************************************************
- Метод synchronizedCollection():
Синхронизированная оболочка - возвращает потокобезопасную коллекцию, резервную копию которой
создает указанная коллекция (Collection).
(см. пример Less_25_SynchronizedCollection_Step4)
...
(см. пример Less_25_SynchronizedCollection_Step3)
...
заключив его в синхронизированный блок (см. пример Less_25_SynchronizedCollection_Step3)!!!
